export class SearchResult {
    ...
    generateResult() {
        ...
        this._descriptionContainerElement = this._element.querySelector(this._descriptionContainerSelector);
        ...
        this._language === null ? this._languageLabelElement.remove() : this._languageElement.textContent = this._language;
        this._description === null ? this._descriptionContainerElement.remove() : this._descriptionElement.textContent = this._description;
